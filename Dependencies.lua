...
-- OpenGLEngine Dependencies

-- VULKAN_SDK = os.getenv("VULKAN_SDK")

IncludeDir = {}
IncludeDir["stb_image"] = "%{wks.location}/OpenGLEngine/vendor/stb_image"
-- IncludeDir["yaml_cpp"] = "%{wks.location}/OpenGLEngine/vendor/yaml-cpp/include"
-- IncludeDir["Box2D"] = "%{wks.location}/OpenGLEngine/vendor/Box2D/include"
...
-- IncludeDir["entt"] = "%{wks.location}/OpenGLEngine/vendor/entt/include"
-- IncludeDir["mono"] = "%{wks.location}/OpenGLEngine/vendor/mono/include"
-- IncludeDir["shaderc"] = "%{wks.location}/OpenGLEngine/vendor/shaderc/include"
-- IncludeDir["SPIRV_Cross"] = "%{wks.location}/OpenGLEngine/vendor/SPIRV-Cross"
-- IncludeDir["VulkanSDK"] = "%{VULKAN_SDK}/Include"
-- IncludeDir["msdfgen"] = "%{wks.location}/OpenGLEngine/vendor/msdf-atlas-gen/msdfgen"
-- IncludeDir["msdf_atlas_gen"] = "%{wks.location}/OpenGLEngine/vendor/msdf-atlas-gen/msdf-atlas-gen"
